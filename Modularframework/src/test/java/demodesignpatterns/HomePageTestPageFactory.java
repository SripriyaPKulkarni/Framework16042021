...
import designPatterns.AmazonHomePageFactory;

public class HomePageTestPageFactory {

	CommonDriver cmnDriver;
	
	AmazonHomePageFactory amazonhomepage;
	...
	public void invokeBrowser() throws Exception{
		...
		amazonhomepage=new AmazonHomePageFactory(driver);
	}
